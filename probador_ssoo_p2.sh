...
echo "mycalc 10 mod 7"      >calc3

#echo "MSH>> mycalc 10 mod 7" > calc3.res
echo "MSH>>[OK] 10 % 7 = 7 * 1 + 3"  >>calc3.res
echo "MSH>>"  >>calc3.res
...
testeo2 calc4 calc4.res  
echo -n "Test18: Calculadora 5 -> "
testeo2 calc5 calc5.res
echo -n "Test19: Calculadora \$Acc -> "
testeoCalc

echo -n "Test20: Backup 1 -> "
testeo2bak bak1 bak1.res  
echo -n "Test21: Backup 2 -> "
testeo2bak bak2 bak2.res  
echo -n "Test22: Backup 3 -> "
testeo3 bak3 bak3.res msh.c msh.c_bak


#background
echo -n "Test23: Background -> "
testeo test21 test21.res

echo "Resumen de pruebas: -> "
fnota=$((echo scale=2 ; echo $nota*10 / 23) | bc )
echo "Nota: $fnota" 
echo $fnota > ../nota.txt
#cat excel
